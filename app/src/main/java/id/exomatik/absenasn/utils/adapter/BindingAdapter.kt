...
import id.exomatik.absenasn.ui.auth.RegisterActivity
...
fun getDateNow(dateFormat: String): String{
...
fun onClickFoto(urlFoto: String, activity: Activity){
    dismissKeyboard(activity)
    val intent = Intent(activity, LihatFotoActivity::class.java)
